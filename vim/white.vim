...
call <SID>X("Comment","ffffff","a9a9a9","none")
call <SID>X("Conditional","e2e4e5","","none")
call <SID>X("Constant","00008b","","none")
...
call <SID>X("DiffAdd","ff0000","ff0000","none")
call <SID>X("DiffChange","ff00ff","ff00ff","none")
call <SID>X("DiffDelete","ff0000","a52a2a","none")
call <SID>X("DiffText","ff00ff","","none")
...
call <SID>X("ErrorMsg","e2e4e5","ffff00","none")
call <SID>X("Exception","e2e4e5","","none")
call <SID>X("Float","e2e4e5","","none")
call <SID>X("FoldColumn","ffff00","a9a9a9","none")
call <SID>X("Folded","ffff00","a9a9a9","none")
call <SID>X("Function","000000","","none")
call <SID>X("Identifier","8b008b","","none")
call <SID>X("Ignore","bebebe","","none")
call <SID>X("IncSearch","ffffff","000000","none")
call <SID>X("Include","e2e4e5","","none")
call <SID>X("Keyword","000000","","none")
call <SID>X("Label","e2e4e5","","none")
call <SID>X("LineNr","ffff00","a9a9a9","none")
call <SID>X("LocalVariable","e2e4e5","","none")
call <SID>X("Macro","e2e4e5","","none")
call <SID>X("MatchParen","e2e4e5","","none")
call <SID>X("ModeMsg","ff0000","","none")
call <SID>X("MoreMsg","006400","","none")
call <SID>X("NonText","000000","ffffff","none")
call <SID>X("Normal","000000","ffffff","none")
call <SID>X("Number","ff00ff","","none")
call <SID>X("Operator","0000ff","","none")
call <SID>X("PMenu","eeeeee","545658","none")
call <SID>X("PMenuSbar","eeeeee","a9a9a9","none")
call <SID>X("PMenuSel","88dd88","949698","none")
call <SID>X("PMenuThumb","eeeeee","ffff00","none")
call <SID>X("PreCondit","e2e4e5","","none")
call <SID>X("PreProc","8b008b","","none")
call <SID>X("Question","006400","","none")
call <SID>X("Repeat","e2e4e5","","none")
call <SID>X("Search","ffffff","000000","none")
call <SID>X("SignColumn","e2e4e5","","none")
call <SID>X("Special","8b0000","","none")
call <SID>X("SpecialChar","e2e4e5","","none")
call <SID>X("SpecialComment","e2e4e5","","none")
call <SID>X("SpecialKey","006400","","none")
...
call <SID>X("StatusLine","000000","","none")
call <SID>X("StatusLineNC","000000","","none")
call <SID>X("StorageClass","e2e4e5","","none")
call <SID>X("String","006400","","none")
...
call <SID>X("Title","ff0000","ffff00","none")
call <SID>X("Todo","ffffff","006400","none")
call <SID>X("Type","0000ff","","none")
call <SID>X("Typedef","e2e4e5","","none")
call <SID>X("Underlined","0000ff","ffff00","none")
...
call <SID>X("WarningMsg","00008b","","none")
call <SID>X("WildMenu","000000","008b8b","none")
